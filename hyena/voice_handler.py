...
class VoiceHandler:
    ...
    def handle(self):
        ...
        try:
            ...
            self.logger.info(f"Removing {local_file_name} from local disk")
    ...
    def __download_telegram_file(self, id: str, output_name: str):
        self.logger.info(f"Downloading {id} and saving as {output_name}")
    ...
    def __upload_to_s3(self, local_file_name: str, s3_file_name: str, bucket_name: str):
        self.logger.info(f"Uploading {local_file_name} to S3 as {s3_file_name}")
